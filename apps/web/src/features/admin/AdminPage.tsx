  ...
  return (
    <div className={styles.page}>
      ...
      <p className={styles.notice} role="note">
        No authentication implemented yet — Admin login arrives in M02. This read-only view exposes
        only sanitized structural diagnostics, never Sheet row contents, passwords, Gate codes,
        private keys, service keys, or Drive file IDs.
      </p>
